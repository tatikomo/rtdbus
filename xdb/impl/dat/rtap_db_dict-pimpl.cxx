...
namespace rtap_db_dict
{
  ...
  static CE_ITEM_pimpl*     ce_item = NULL;
  ...
  rtap_db_dict::idx_t ValueEntry_pimpl::
  post_ValueEntry ()
  {
    long long v (post_integer ());

    if ((0 <= v) && (v <= VALUE_ENTRY_MAX))
      m_value = static_cast<rtap_db_dict::idx_t>(v);
  ...
  rtap_db_dict::idx_t UnityIdEntry_pimpl::
  post_UnityIdEntry ()
  {
    long long v (post_integer ());
  ...
  rtap_db_dict::idx_t UnityDimensionType_pimpl::
  ...
  void Identifier_pimpl::
  pre ()
  {
    m_value = 0;
  }

  rtap_db_dict::idx_t Identifier_pimpl::
  post_Identifier ()
  {
    long long v (post_long ());
  ...
  rtap_db_dict::idx_t UnityIdType_pimpl::
  post_UnityIdType ()
  {
    long long v (post_integer ());
  ...
  void ActionScript_pimpl::
  pre ()
  {
  }

  rtap_db_dict::Label_t& ActionScript_pimpl::
  post_ActionScript ()
  {
    const ::std::string& v (post_string ());

    m_value.assign(v);
    // TODO: проверка на корректность макроса?
    return m_value;
  }
  ...
  void UNITY_LABEL_pimpl::
  UnityDimensionId (const rtap_db_dict::idx_t& UnityDimensionId)
  {
  ...
  void UNITY_LABEL_pimpl::
  UnityId (const rtap_db_dict::idx_t& UnityId)
  {
  ...
  void VAL_LABEL_pimpl::
  Val (const rtap_db_dict::idx_t& Val)
  {
    m_data.value = Val;
  }
  ...
  void CE_ITEM_pimpl::
  Id (const rtap_db_dict::idx_t& Id)
  {
    m_data.id = Id;
  }

  void CE_ITEM_pimpl::
  CE (rtap_db_dict::Label_t& CE)
  {
    m_data.definition.assign(CE);
  }
